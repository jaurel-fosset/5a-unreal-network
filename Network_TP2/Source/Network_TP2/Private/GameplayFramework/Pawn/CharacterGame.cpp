...
void ACharacterGame::Server_ShootWithRewind_Implementation(const double Timestamp)
{
	...
	const TObjectPtr<AActor> ShotActor = ShootComponent->Shoot(GetWorld(), ServerRewindCollisionChannel,
	                                                           FColor::Green, FColor::Blue, Info.PlayerPosition, Info.PlayerRotation.Rotator());
...
void ACharacterGame::Shoot()
{
	...
	const TObjectPtr<AActor> ShotActor = ShootComponent->Shoot(World, ECC_Pawn,
